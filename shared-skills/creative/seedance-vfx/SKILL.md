---
name: seedance-vfx
description: "This skill should be used when the user asks for VFX, particles, energy, destruction, transformation, weather effects, magical effects, explosions, smoke, fire, water, or physically plausible effects in Seedance 2.0.（中文触发：Seedance特效、粒子、能量、破坏、魔法时加载）"
license: MIT
user-invocable: true
tags:
  - vfx
