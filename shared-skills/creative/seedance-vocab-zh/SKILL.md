...
description: "This skill should be used when the user asks for Chinese Seedance 2.0 prompt wording, Mandarin cinematic vocabulary, Chinese prompt compression, or translation of camera, lighting, action, VFX, audio, and production terms into Chinese.（中文触发：Seedance中文措辞、中文电影词汇、中文提示词压缩时加载）"
license: MIT
user-invocable: true
tags:
  - chinese
...
Load the vocabulary table in this file (below) for dense role-binding, first/last-frame, camera, lighting, audio, edit/extend, constraint, and safety vocabulary.
...
When the prompt leans on `电影感`, `氛围感`, `高级感`, `大片感`, or bare `质感`, decompose each into the physical elements that produce it - 材质, 光线, 色彩, 空气 - using the anti-slop rules in the seedance-antislop skill.
